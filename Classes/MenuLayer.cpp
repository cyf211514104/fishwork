...
void MenuLayer::createMenu()
{
	...
	CCMenuItemLabel* musicOn = CCMenuItemLabel::create(CCLabelTTF::create("music : open", fontName->getCString(), fontSize));
	CCMenuItemLabel* musicOff = CCMenuItemLabel::create(CCLabelTTF::create("music : close", fontName->getCString(), fontSize));
